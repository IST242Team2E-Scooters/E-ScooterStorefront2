...
// https://github.com/IST242Team2E-Scooters/E-ScooterStorefront

/**
 *
 */
public class Main {
    /** The class that runs the storefront
     *
     * @param args
     */
    public static void main(String[] args) {
        ...
        while (true) {                                          // Infinite loop for STOREFRONT
            double total = 0.00;                                // initialize a variable to keep track of total cost
                ...
                for (int x = 0; x < 6; x++) {
                    for (int y = 0; y < 6; y++) {
                        for (int z = 0; z < 6; z++) {
                            ...
                            if (item != null && item.getCategory().ordinal() + 1 == selectedCategory) {     // Check if the item is not null and belongs to selected category, ordinality adds 1 to the enum because starts at 0
    ...
    /** Runs the provideChangeInDenominations method to return change to the customer.
     *
     * @param change
     */
